...
namespace TravianBot.Core
{
	...
	{
        public static Tribes GetTribe(HtmlDocument doc)
        {
        ...
        public static List<Village> GetVillages(HtmlDocument doc)
        {
        ...
        public static List<Building> GetSuburbsBuildings(HtmlDocument doc, int villageId)
        {
        ...
        public static List<Building> GetCityBuildings(HtmlDocument doc, int villageId)
        {
            ...
            var tribe = GetTribe(doc);

            return GetCityBuildingsWithLevel(buildingNodes, levelPairs, villageId, tribe);
        }

        private static List<Building> GetCityBuildingsWithLevel(IEnumerable<HtmlNode> buildingNodes,
            Dictionary<int, int> levelPairs, int villageId, Tribes tribe)
        {
            var buildings = new List<Building>();
            foreach (var buildingNode in buildingNodes)
            {
        ...
        public static string GetBuildCode(HtmlDocument doc)
        {
